...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.50(Phase 4(Inc.1)Step 46 SHA 追記事後処理時点(CR-0032 / GitHub Issue #42、教訓水平展開 / 改善 CR、PRB-0009 / GitHub Issue #41 連動、CR-0032 状態 OPEN → CLOSED 遷移完了、本体 `c3faacc` + CI run id `25869141248` Documentation Checks success ✅、C++ Build (Inc.1) は paths filter で skip)。`inc1-requirements-frozen` + `inc1-design-frozen` 確定済。SOUP 13 件正式登録、CI-DOC-CRR を v0.47 → v0.48、CI-DOC-SPRP を v0.3 → v0.4、CI-DOC-CLAUDE に「SHA 追記事後処理チェックリスト」運用ルール追加、CI-DOC-DEVSTEPS を v0.56 → v0.57。PRB-0009「SHA 追記事後処理時の集計系ドキュメントテーブル更新漏れ」の教訓水平展開を実施、CRR §5/§6/§7/§7.1/§7.2 集計系テーブルを一括バックフィル + CLAUDE.md に運用ルール追加で再発を構造的に予防) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.48(Step 13〜46 で CR-0001〜0032 を §4 本体表に登録。**CR-0001〜0032 全 CLOSED**(Step 46 SHA 追記事後処理で CR-0032 状態 OPEN → CLOSED 遷移完了、本体 `c3faacc` + CI run id `25869141248`(Documentation Checks success ✅、2026-05-15)、C++ Build (Inc.1) は paths filter で skip、クローズ日 2026-05-15)。32 件すべて MAJOR・安全関連。**§5 安全関連 CR 抽出 / §6 リリース別 / §7・§7.1・§7.2 集計表を一括バックフィル**(計 32 件全登録、Step 43〜46 完了時行追加)。Therac-25 主要因類型: 累積 A:28 / B:3 / C:0 / D:11 / E:9 / F:31。**PRB-0007〜0009 起票 3 件**(SPRP §3.1 本格運用第 5〜7 例、PRB-0009 = 新類型「SHA 追記事後処理時の集計系ドキュメントテーブル更新漏れ」、Step 46 / CR-0032 で教訓水平展開実施)) |
| 9 問題解決 | ソフトウェア問題解決手順書(SPRP) | [`9_.../software_problem_resolution_procedure.md`](./9_software_problem_resolution_process/software_problem_resolution_procedure.md) | 🟡 v0.4(GitHub Issue ベースの PRB-NNNN 運用、根本原因 13 分類、Therac-25 事故 5 主要因チェックリストを Critical 案件で必須化、傾向分析に Therac-25 主要因類型別集計を組込、Step 39 / CR-0026 で v0.1 → v0.2、Step 43 / CR-0029 で v0.2 → v0.3、**Step 46 / CR-0032 で v0.3 → v0.4 昇格**(§12 改訂履歴に PRB-0009 起票記録 + 教訓水平展開運用ルール本格運用第 4 例 + 新類型「SHA 追記事後処理時の集計系ドキュメントテーブル更新漏れ」を §8.2 分析項目への運用上の追加類型として組込、冒頭バージョンが v0.3 改訂時に 0.2 据え置きだった点も整合化)) |
...
詳細は SDP §6.2 および 構成アイテム一覧(CIL-TH25-001 v0.50)§5/§6/§7 を参照。
