...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.28(Phase 4(Inc.1)Step 33 完了時点。`inc1-requirements-frozen` + `inc1-design-frozen` 確定済。SOUP 13 件正式登録、CI-SRC-001 / CI-SRC-005 ともに本 Step では本体ソース変更なし(Step 33 / CR-0021 は試験ハーネス改善のみ)、CI-DOC-UTPR v0.18、CI-DOC-CRR を v0.25 → v0.26(CR-0021 OPEN、本格運用第 21 例)、CI-DOC-DEVSTEPS を v0.34 → v0.35 に昇格、**Step 33 / CR-0021 で教訓水平展開 / 改善 CR を実施**(全 UT 並行試験 11 箇所を do-while パターン化、SPRP §3.1 PRB 起票プロセスの教訓水平展開運用ルールの本格運用初例)) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.26(Step 13〜33 で CR-0001〜0021 を §4 本体表に登録。**CR-0001〜0020 全 CLOSED + CR-0021 OPEN**(教訓水平展開 / 改善 CR、本体 SHA + CI run id は push 後追記)。21 件すべて MAJOR・安全関連。Therac-25 主要因類型: 累積 A:21 / B:3 / D:9 / E:4 / F:20。集計表に Step 13〜33 完了時行を追加。**Step 22 で SPRP §3.1 PRB 起票プロセスの本格運用第 1 例(PRB-0001/0002)、Step 23 で第 2 例(PRB-0003/0004)、Step 30 で第 3 例(PRB-0005)、Step 32 で第 4 例(PRB-0006、Step 30 PRB-0005 と完全同一の根本原因)が成立、Step 33 で教訓水平展開運用ルールの本格運用初例として CR-0021 を実施**(全 UT 並行試験 11 箇所を do-while パターン化、PRB-0007 以降の同根本原因再発を構造的予防)) |
...
詳細は SDP §6.2 および 構成アイテム一覧(CIL-TH25-001 v0.28)§5/§6/§7 を参照。
