...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.32(Phase 4(Inc.1)Step 35 完了時点。`inc1-requirements-frozen` + `inc1-design-frozen` 確定済。SOUP 13 件正式登録、**CI-SRC-004 を Step 35 で UNIT-101 + UNIT-102 BeamCommandConsole 空殻に拡大**(`th25_ui` ライブラリの 2 cpp 目組込、新ライブラリ追加なし、空殻実装としては第 5 例)、CI-SRC-001 / CI-SRC-005 は変更なし、CI-DOC-UTPR v0.21、CI-DOC-CRR v0.30(CR-0023 OPEN → push 後 CLOSED 予定)、CI-DOC-DEVSTEPS v0.39 に昇格) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.30(Step 13〜35 で CR-0001〜0023 を §4 本体表に登録。**CR-0001〜0022 全 CLOSED**、CR-0023 OPEN → push 後 SHA 追記事後処理で CLOSED 予定。23 件すべて MAJOR・安全関連。Therac-25 主要因類型: 累積 A:23 / B:3 / D:9 / **E:6** / **F:22**。集計表に Step 13〜35 完了時行を追加) |
...
詳細は SDP §6.2 および 構成アイテム一覧(CIL-TH25-001 v0.32)§5/§6/§7 を参照。
