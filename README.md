...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.22(Phase 4(Inc.1)Step 30 完了時点。`inc1-requirements-frozen` + `inc1-design-frozen` 確定済。SOUP 13 件正式登録、**CI-SRC-001 を UNIT-200/401/201/202/203/204/205/206/208 から + UNIT-207 SafetyMonitor 空殻(Inc.2 で本格化予定 / 独立並行タスクのインターロック監視 / 空殻実装としては第 1 例)に拡大、`th25_ctrl` ライブラリの 9 cpp 目として組込**、CI-SRC-005 は UNIT-301〜304 で Hardware Simulator 層完成済、CI-DOC-UTPR を v0.13 → v0.14 に昇格) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.20(Step 13〜30 で CR-0001〜0018 を §4 本体表に登録。18 件すべて MAJOR・安全関連、CR-0001〜0017 CLOSED + CR-0018 OPEN(UNIT-207 SafetyMonitor 空殻 + UTPR v0.14、**Inc.2 で本格化予定の独立並行タスクのインターロック監視ユニット、空殻実装としては第 1 例 → Inc.1 範囲全 14 ユニット展開完了**)。Therac-25 主要因類型: 累積 A:18 / B:3 / D:9(本 v0.14 では IF 骨格 + 並行設計の構造のみ、Inc.2 で本格化)/ E:2 / **F:18 新規**(UNIT-207 で `static_assert` 二重表明(`std::atomic<bool>` + `std::atomic<std::uint64_t>`)を **14 ユニット目に拡大、Inc.1 範囲全 14 ユニット展開完了**)。集計表に Step 13〜30 完了時行を追加。Step 22 で SPRP §3.1 PRB 起票プロセスの本格運用第 1 例(PRB-0001/0002)、Step 23 で第 2 例(PRB-0003/0004)が成立、Step 24〜30 では Step 23/26〜29 教訓の継続反映により PRB 起票なし予定(7 連続クリーンコミット成立予定)) |
...
詳細は SDP §6.2 および 構成アイテム一覧(CIL-TH25-001 v0.22)§5/§6/§7 を参照。
