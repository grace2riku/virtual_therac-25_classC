...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.24(Phase 4(Inc.1)Step 31 完了時点。`inc1-requirements-frozen` + `inc1-design-frozen` 確定済。SOUP 13 件正式登録、**CI-SRC-001 を UNIT-200/401/201/202/203/204/205/206/208/207 から + UNIT-209 AuditLogger 空殻(Inc.4 で本格化予定 / 安全関連イベントの集約・永続化 / 空殻実装としては第 2 例)に拡大、`th25_ctrl` ライブラリの 10 cpp 目として組込**、CI-SRC-005 は UNIT-301〜304 で Hardware Simulator 層完成済、CI-DOC-UTPR v0.15、CI-DOC-CRR を v0.21 → v0.22(CR-0019 登録)、CI-DOC-DEVSTEPS を v0.30 → v0.31 に昇格) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.22(Step 13〜31 で CR-0001〜0019 を §4 本体表に登録。CR-0001〜0018 全 CLOSED、CR-0019 OPEN。19 件すべて MAJOR・安全関連。Therac-25 主要因類型: 累積 A:19 / B:3 / D:9 / **E:3 新規**(UNIT-209 で「全 UNIT 安全関連イベントの集約・事後監査経路」の構造的位置づけ、Inc.4 で本格化)/ **F:19 新規**(UNIT-209 で `static_assert` 二重表明を **15 ユニット目に拡大、Inc.1 範囲全 14 ユニット + 空殻ユニット第 2 例**)。集計表に Step 13〜31 完了時行を追加。**Step 22 で SPRP §3.1 PRB 起票プロセスの本格運用第 1 例(PRB-0001/0002)、Step 23 で第 2 例(PRB-0003/0004)、Step 30 で第 3 例(PRB-0005)が成立**。Step 24〜29 / Step 31 では教訓の継続反映により PRB 起票なし) |
...
詳細は SDP §6.2 および 構成アイテム一覧(CIL-TH25-001 v0.24)§5/§6/§7 を参照。
