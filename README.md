...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.49(Phase 4(Inc.1)Step 46 完了時点(CR-0032 / GitHub Issue #42、教訓水平展開 / 改善 CR、PRB-0009 / GitHub Issue #41 連動)。`inc1-requirements-frozen` + `inc1-design-frozen` 確定済。SOUP 13 件正式登録、CI-DOC-CRR を v0.46 → v0.47(§5 に CR-0021/0026〜0031 + CR-0032 / §6 に CR-0029/0030 + CR-0032 / §7・§7.1・§7.2 に Step 43〜46 完了時行を一括バックフィル)、CI-DOC-SPRP を v0.3 → v0.4、CI-DOC-CLAUDE に「SHA 追記事後処理チェックリスト」運用ルール追加、CI-DOC-DEVSTEPS を v0.55 → v0.56。PRB-0009「SHA 追記事後処理時の集計系ドキュメントテーブル更新漏れ」の教訓水平展開を実施、CLAUDE.md に運用ルール追加で再発を構造的に予防) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.47(Step 13〜46 で CR-0001〜0032 を §4 本体表に登録。**CR-0001〜0031 全 CLOSED + CR-0032 OPEN**(Step 46 / CR-0032 起票、教訓水平展開 / 改善 CR、push 後 SHA 追記事後処理で CLOSED 予定)。32 件すべて MAJOR・安全関連。**§5 安全関連 CR 抽出 / §6 リリース別 / §7・§7.1・§7.2 集計表を一括バックフィル**(計 32 件全登録、Step 43〜46 完了時行追加)。Therac-25 主要因類型: 累積 A:28 / B:3 / C:0 / D:11 / E:9 / F:31。**PRB-0007〜0009 起票 3 件**(SPRP §3.1 本格運用第 5〜7 例、PRB-0009 = 新類型「SHA 追記事後処理時の集計系ドキュメントテーブル更新漏れ」、Step 46 / CR-0032 で教訓水平展開実施)) |
...
詳細は SDP §6.2 および 構成アイテム一覧(CIL-TH25-001 v0.49)§5/§6/§7 を参照。
