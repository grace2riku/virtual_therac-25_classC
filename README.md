...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.11(Step 13〜21 で CR-0001〜0009 を §4 本体表に登録。9 件すべて MAJOR・安全関連(CR-0009 は UNIT-203 + UTPR v0.5、**RCM-017 中核 / 許可フラグ消費型**, VERIFICATION)。Therac-25 主要因類型: 累積 A:9 / B:2 / **D:5 新規** / E:2 / F:9。集計表に Step 13〜21 完了時行を追加) |
