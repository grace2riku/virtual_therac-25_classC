...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.10(Step 13〜20 で CR-0001〜0007 を CLOSED、CR-0008(UNIT-202 + UTPR v0.4、**HZ-001 直接対応の中核**, VERIFICATION)を §4 本体表に登録。8 件すべて MAJOR・安全関連。Therac-25 主要因類型: 累積 A:8 / B:2 / **D:4 新規** / E:2 / F:8。集計表に Step 13〜20 完了時行を追加) |
