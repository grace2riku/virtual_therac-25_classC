...
| 5.5 | ユニット試験計画書/報告書 | [`5.5_.../software_unit_test_plan_report.md`](./5.5_software_unit_implementation/software_unit_test_plan_report.md) | 🟡 v0.33(Step 17 で初版、Step 18〜35 事後処理で v0.2〜v0.22、Step 36 / CR-0024 で v0.23、Step 36 SHA 追記事後処理で v0.24、Step 37 / CR-0025 で v0.25、Step 37 SHA 追記事後処理で v0.26、Step 39 / CR-0026 で v0.27、Step 40 / CR-0027 で v0.28、Step 40 SHA 追記事後処理で v0.29、Step 41 / CR-0028 で v0.30、Step 42 で v0.31、Step 43 / CR-0029 で v0.32、**Step 43 SHA 追記事後処理(Step 40 パターン、独立 Step 番号なし)で v0.32 → v0.33 昇格**(§8.4 Step 43 / CR-0029 範囲行を実績値に更新: 本体 `64ac5f0` 確定 + CI run id `25785087399` Documentation Checks success ✅ 確定 + 1 コミット初回 CI Pass 復活第 2 例成立追記、§11 改訂履歴 v0.33)。§3 実装ルール、§4.2 並行処理 RCM の 3 層検証、§5/§6/§6.1 受入基準を確定。**§7 累積 410 件を定義**、後続 Step 44+ で UNIT-201 SafetyCoreOrchestrator 結線 + UNIT-203 BeamController dispatch を実施予定) |
...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.44(Phase 4(Inc.1)Step 43 SHA 追記事後処理時点(Step 40 パターン、独立 Step 番号なし、CR-0029 状態 OPEN → CLOSED 遷移完了、本体 `64ac5f0` + CI run id `25785087399`(Documentation Checks success ✅、16 秒、2026-05-13)+ C++ Build paths filter で skip + クローズ日 2026-05-13 確定、**1 コミット初回 CI Pass 復活第 2 例成立**)。`inc1-requirements-frozen` + `inc1-design-frozen` 確定済。SOUP 13 件正式登録、CI-DOC-UTPR を v0.32 → v0.33、CI-DOC-CRR を v0.41 → v0.42(CR-0029 CLOSED + 本体 SHA + CI run id 確定)、CI-DOC-DEVSTEPS を v0.50 → v0.51) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.42(Step 13〜43 で CR-0001〜0029 を §4 本体表に登録。**CR-0001〜0029 全 CLOSED**(本 Step 43 SHA 追記事後処理で CR-0029 状態 OPEN → CLOSED 遷移完了、本体 `64ac5f0` + CI run id `25785087399`(Documentation Checks success ✅、16 秒、2026-05-13)+ C++ Build paths filter で skip + クローズ日 2026-05-13)。29 件すべて MAJOR・安全関連。Therac-25 主要因類型: 累積 A:27 / B:3 / D:9 / **E:9** / **F:28**。集計表 Step 43 完了時行を実績値に更新(**1 コミット初回 CI Pass 復活第 2 例成立**、Step 40 で達成した第 1 例に続く、サイクル 2 周目完成)。**PRB-0007 + PRB-0008 起票 2 件**(SPRP §3.1 本格運用第 5 例 + 第 6 例、新類型 2 件: 「他ユニット UT テンプレ流用時の Severity マッピング自己セルフチェック漏れ」+「並行 UT 追加時の target 値 SRS-008 範囲内セルフチェック漏れ」)) |
...
詳細は SDP §6.2 および 構成アイテム一覧(CIL-TH25-001 v0.44)§5/§6/§7 を参照。
