...
| 5.5 | ユニット試験計画書/報告書 | [`5.5_.../software_unit_test_plan_report.md`](./5.5_software_unit_implementation/software_unit_test_plan_report.md) | 🟡 v0.19(Step 17 で初版、Step 18〜33 で v0.2〜v0.18、Step 34 / CR-0022 で v0.19 昇格。§3 実装ルール、§4.2 並行処理 RCM の 3 層検証、§5/§6/§6.1 受入基準を確定。**§7 累積 357 件を定義(UNIT-200 24 + UNIT-401 13 + UNIT-201 24 + UNIT-202 26 + UNIT-203 19 + UNIT-204 32 + UNIT-205 25 + UNIT-206 31 + UNIT-208 29 + UNIT-301 19 + UNIT-302 19 + UNIT-303 24 + UNIT-304 24 + UNIT-207 12 + UNIT-209 12 + UNIT-210 12 + UNIT-101 12(Inc.4 で本格化予定の治療計画入力 UI ユニット、空殻実装としては第 4 例、新ライブラリ `th25_ui` 新設))**、`test_prescription_editor.cpp` 新規追加。後続 Step 35+ で UNIT-102/103/104 / UNIT-402 等を順次追加) |
