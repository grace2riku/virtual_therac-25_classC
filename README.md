...
| 8 構成管理 | 構成アイテム一覧(CIL) | [`8_.../configuration_item_list.md`](./8_software_configuration_management_process/configuration_item_list.md) | 🟡 v0.1(Phase 2 終了時点。ドキュメント 22 件、SOUP 候補 19 件、ツール 7 件運用中、構成定義 8 件運用中、TSan ランタイムを HZ-002 直接対応として明示分類) |
...
| 8 構成管理 | 変更要求台帳 | [`8_.../change_request_register.md`](./8_software_configuration_management_process/change_request_register.md) | 🟡 v0.1(空台帳、Therac-25 事故主要因類型 A〜F 別件数集計表を新設) |
