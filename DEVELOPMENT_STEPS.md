...
| Step | 内容 | 予定 |
|------|------|------|
| Step 18 | **Inc.1 中核ユニット実装(UNIT-401 InProcessQueue + UNIT-201 SafetyCoreOrchestrator 等)**。MessageBus(`folly::ProducerConsumerQueue` または独自 SPSC 実装、`vcpkg.json` 依存追加)、`LifecycleState` 状態機械(8 状態 + 遷移許可表)、UTPR v0.2 へ昇格 + 該当 UT 追加 | 次回作業時 |
| Step 19+ | **残ユニット実装**(UNIT-202〜206 / 208 / 301〜304 / 402)+ UT 追加。Inc.2/4 該当の UNIT-207/209/210 / 101〜104 は空殻実装(SDD §4.8/4.10/4.11 と整合)| Step 18 完了後 |
