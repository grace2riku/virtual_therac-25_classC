...
**バージョン:** 0.19
**作成日:** 2026-04-26(初版)/ 2026-04-29(v0.2)/ 2026-04-30(v0.3〜v0.5)/ 2026-05-01(v0.6〜v0.10)/ 2026-05-02(v0.11)/ 2026-05-04(v0.12〜v0.13)/ 2026-05-07(v0.14〜v0.15)/ 2026-05-08(v0.16〜v0.18)/ 2026-05-09(v0.19)
...
| 実施期間 | 2026-05-09 |
| 実施者 | k-abe |
| 対象ソフトウェアバージョン(コミット)| 本体: (push 後 SHA を追記) |
...
| 試験環境(CI 完全実行)| Ubuntu 24.04 + clang-17 / gcc-13、4 プリセット × 2 コンパイラ = 8 ジョブ + clang-tidy ジョブ。`th25_prescription_editor_tests` 12 件追加。GitHub Actions cpp-build ワークフロー(run id push 後追記、2026-05-09、最終コミット push 後追記)+ Documentation Checks(run id push 後追記)|
| **CI 結果** | (push 後追記) |
...
| (Step 34 / CR-0022 範囲、UNIT-101 PrescriptionEditor 空殻、空殻実装第 4 例)| (ローカル骨格ビルド成功、**新ライブラリ `th25_ui` 完全ビルド成功**、`prescription_editor.cpp` を `th25_ui` ライブラリの 1 cpp 目として組込、`static_assert` 単一表明(`std::atomic<std::uint64_t>`)通過、CI 結果は push 後に追記、Step 26〜33 教訓継続反映 + 空殻ユニット 1〜3 例パターン踏襲により初版即ビルド成功、PRB 起票なし見込み)| Minor 以下 | — | **(push 後に CI 結果追記)** |
...
### UNIT-101(本 Step 34 / CR-0022、Inc.4 で本格化予定の治療計画入力 UI ユニット 空殻実装、空殻実装としては第 4 例、CI 実績は push 後追記)

| ユニット ID | 試験 ID | 関連 SRS / SDD | 関連 RCM / HZ | CI ジョブ Pass |
|------------|--------|--------------|------------|--------------|
| UNIT-101 | UT-101-01 | SDD §3.2(初期状態)| RCM-002 | 全 9 ジョブ Pass(push 後追記)|
...
| UNIT-101 | **UT-101-11** | **SRS-D-009 / SDD §3.2 / §9 SEP-003(4 thread × 500 submit_prescription 並行、submit_count atomic 整合性)**| **RCM-002 / RCM-019 / HZ-002** | **`tsan` プリセットで race 0 確認 push 後追記** |
