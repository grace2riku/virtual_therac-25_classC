...
**バージョン:** 0.20
**作成日:** 2026-04-26(初版)/ 2026-04-29(v0.2)/ 2026-04-30(v0.3〜v0.5)/ 2026-05-01(v0.6〜v0.10)/ 2026-05-02(v0.11)/ 2026-05-04(v0.12〜v0.13)/ 2026-05-07(v0.14〜v0.15)/ 2026-05-08(v0.16〜v0.18)/ 2026-05-09(v0.19〜v0.20)
**対象製品:** 仮想 Therac-25(Virtual Therac-25) / TH25-SIM-001
**対象ソフトウェアバージョン:** 0.2.0(Inc.1 完了で初回機能リリース予定)
**安全クラス:** C(IEC 62304)
**変更要求:** CR-0005〜0019 + CR-0020(GitHub Issue #26、v0.16 UNIT-210 CoreAuthenticationGateway 空殻実装追加、Inc.4 で本格化予定の操作者認証ゲートウェイユニットを SDD §4.11 に基づき空殻 IF 骨格 + verify(常時 AuthRequired)+ verify_count + AuthenticationVerify/AuthenticationResult/OperatorId/Credential 構造体として実装、空殻実装としては第 3 例)
...
>
> **本 v0.16(Step 32 / CR-0020)では UNIT-210 CoreAuthenticationGateway(Inc.4 で本格化予定の操作者認証ゲートウェイユニット、本 v0.1 範囲では空殻 + IF のみ)を追加**。空殻実装としては第 3 例で、SDD §4.11 に基づき `verify`(常時 `ErrorCode::AuthRequired` 返却)同期 API + `verify_count` + `reset_for_test` 補助 API + `AuthenticationVerify` / `AuthenticationResult` / `OperatorId` / `Credential` 空殻 IF 構造体(IF-U-010 と整合)+ `std::atomic<std::uint64_t>` 単一 atomic + lock-free 単一表明を含む構造を確立。UNIT-101〜104 / 402 の試験計画・実績は後続 SDD-準拠ステップで追加する。
...
| UNIT-102〜104 | Operator UI 群(残空殻) | k-abe | `src/th25_ui/...`(Step 35+ で追加予定) | (Step 35+ Inc.4 該当残空殻ユニットとして順次追加) |
...
**累積合計試験ケース(UNIT-200 + UNIT-401 + UNIT-201 + UNIT-202 + UNIT-203 + UNIT-204 + UNIT-205 + UNIT-206 + UNIT-208 + UNIT-301 + UNIT-302 + UNIT-303 + UNIT-304 + UNIT-207 + UNIT-209 + UNIT-210 + UNIT-101)= 357 件**
