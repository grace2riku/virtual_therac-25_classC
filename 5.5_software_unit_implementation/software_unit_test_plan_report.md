...
**バージョン:** 0.16
**作成日:** 2026-04-26(初版)/ 2026-04-29(v0.2)/ 2026-04-30(v0.3〜v0.5)/ 2026-05-01(v0.6〜v0.10)/ 2026-05-02(v0.11)/ 2026-05-04(v0.12〜v0.13)/ 2026-05-07(v0.14〜v0.15)/ 2026-05-08(v0.16)
...
| 試験環境(CI 完全実行)| Ubuntu 24.04 + clang-17 / gcc-13、4 プリセット × 2 コンパイラ = 8 ジョブ + clang-tidy ジョブ。`th25_core_authentication_gateway_tests` 12 件追加。GitHub Actions cpp-build ワークフロー(run id push 後追記、2026-05-08、最終コミット push 後追記)+ Documentation Checks(run id push 後追記)|
| **CI 結果** | (push 後追記) |
...
| (Step 32 / CR-0020 範囲)| (ローカル骨格ビルド成功、`th25_ctrl` ライブラリに `core_authentication_gateway.cpp` を 11 cpp 目として組込成功、`static_assert` 単一表明(`std::atomic<std::uint64_t>`)通過、CI 結果は push 後に追記、Step 24〜31 教訓継続反映 + Sim 層 / 空殻ユニット 1〜2 例パターン踏襲により初版即ビルド成功、PRB 起票なし見込み)| Minor 以下 | — | **(push 後に CI 結果追記)** |
...
### UNIT-210(本 Step 32 / CR-0020、Inc.4 で本格化予定の操作者認証ゲートウェイユニット 空殻実装、空殻実装としては第 3 例、CI 実績は push 後追記)

| ユニット ID | 試験 ID | 関連 SRS / SDD | 関連 RCM / HZ | CI ジョブ Pass |
|------------|--------|--------------|------------|--------------|
| UNIT-210 | UT-210-01 | SDD §4.11(初期状態)| RCM-002 | 全 9 ジョブ Pass(push 後追記)|
...
| UNIT-210 | **UT-210-11** | **SRS-D-009 / SDD §4.11 / §9 SEP-003(4 thread × 500 verify 並行、verify_count atomic 整合性)**| **RCM-002 / RCM-019 / HZ-002 / HZ-010** | **`tsan` プリセットで race 0 確認 push 後追記** |
