...
**バージョン:** 0.14
**作成日:** 2026-04-26(初版)/ 2026-04-29(v0.2)/ 2026-04-30(v0.3〜v0.5)/ 2026-05-01(v0.6〜v0.10)/ 2026-05-02(v0.11)/ 2026-05-04(v0.12〜v0.13)/ 2026-05-07(v0.14)
**対象製品:** 仮想 Therac-25(Virtual Therac-25) / TH25-SIM-001
**対象ソフトウェアバージョン:** 0.2.0(Inc.1 完了で初回機能リリース予定)
**安全クラス:** C(IEC 62304)
**変更要求:** CR-0005〜0017 + CR-0018(GitHub Issue #22、v0.14 UNIT-207 SafetyMonitor 空殻実装追加、Inc.2 で本格化予定の独立並行タスクのインターロック監視ユニットを SDD §4.8 に基づき空殻 IF 骨格 + stop シグナル + tick_count として実装、空殻実装としては第 1 例)
...
>
> **本 v0.14(Step 30 / CR-0018)では UNIT-207 SafetyMonitor(Inc.2 で本格化予定の独立並行タスクのインターロック監視ユニット、本 v0.1 範囲では空殻 + IF のみ)を追加**。空殻実装としては第 1 例で、SDD §4.8 に基づき `run_monitor_thread` + `stop` API + `stop_requested_` / `tick_count_` の二重 atomic + lock-free 二重表明を含む構造を確立。UNIT-209 / 210 / 402 の試験計画・実績は後続 SDD-準拠ステップで追加する。
...
**累積合計試験ケース(UNIT-200 + UNIT-401 + UNIT-201 + UNIT-202 + UNIT-203 + UNIT-204 + UNIT-205 + UNIT-206 + UNIT-208 + UNIT-301 + UNIT-302 + UNIT-303 + UNIT-304 + UNIT-207)= 321 件**
