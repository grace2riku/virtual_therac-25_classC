...
**バージョン:** 0.11
**作成日:** 2026-04-26(初版)/ 2026-04-29(v0.2)/ 2026-04-30(v0.3〜v0.5)/ 2026-05-01(v0.6〜v0.10)/ 2026-05-02(v0.11)
**対象製品:** 仮想 Therac-25(Virtual Therac-25) / TH25-SIM-001
**対象ソフトウェアバージョン:** 0.2.0(Inc.1 完了で初回機能リリース予定)
**安全クラス:** C(IEC 62304)
**変更要求:** CR-0005〜0014 + CR-0015(GitHub Issue #19、v0.11 UNIT-302 追加、Hardware Simulator 層 2 ユニット目 / 仮想ベンディング磁石応答模擬)
...
>
> **本 v0.11(Step 27 / CR-0015)では UNIT-302 BendingMagnetSim(Hardware Simulator 層 2 ユニット目 / 仮想ベンディング磁石応答模擬)を追加**。UNIT-207 / 209 / 210 / 303 / 304 / 402 の試験計画・実績は後続 SDD-準拠ステップで追加する。
...
| [11] | 構成アイテム一覧(CIL-TH25-001) | 0.19 |
| [12] | CCB 運用規程(CCB-TH25-001) | 0.1 |
| [13] | 変更要求台帳(CRR-TH25-001) | 0.17 |
...
| **UNIT-302** | **BendingMagnetSim** | k-abe | `src/th25_sim/include/th25_sim/bending_magnet_sim.hpp` + `src/bending_magnet_sim.cpp` | **本 v0.11 で計画 + 実施記録(Step 27 / CR-0015、Hardware Simulator 層 2 ユニット目 / 仮想ベンディング磁石応答模擬)** |
...
| UNIT-303〜304 | Hardware Simulator 残ユニット(TurntableSim / IonChamberSim) | k-abe | `src/th25_sim/...` | 同上(Step 28+ で順次追加) |
...
**累積合計試験ケース(UNIT-200 + UNIT-401 + UNIT-201 + UNIT-202 + UNIT-203 + UNIT-204 + UNIT-205 + UNIT-206 + UNIT-208 + UNIT-301 + UNIT-302)= 261 件**
