...
**バージョン:** 0.15
**作成日:** 2026-04-26(初版)/ 2026-04-29(v0.2)/ 2026-04-30(v0.3〜v0.5)/ 2026-05-01(v0.6〜v0.10)/ 2026-05-02(v0.11)/ 2026-05-04(v0.12〜v0.13)/ 2026-05-07(v0.14〜v0.15)
**対象製品:** 仮想 Therac-25(Virtual Therac-25) / TH25-SIM-001
**対象ソフトウェアバージョン:** 0.2.0(Inc.1 完了で初回機能リリース予定)
**安全クラス:** C(IEC 62304)
**変更要求:** CR-0005〜0018 + CR-0019(GitHub Issue #25、v0.15 UNIT-209 AuditLogger 空殻実装追加、Inc.4 で本格化予定の安全関連イベントの集約・永続化ユニットを SDD §4.10 に基づき空殻 IF 骨格 + publish + run_io_thread + processed_count として実装、空殻実装としては第 2 例)
...
>
> **本 v0.15(Step 31 / CR-0019)では UNIT-209 AuditLogger(Inc.4 で本格化予定の安全関連イベントの集約・永続化ユニット、本 v0.1 範囲では空殻 + IF のみ)を追加**。空殻実装としては第 2 例で、SDD §4.10 に基づき `publish` + `run_io_thread` + `stop` API + `stop_requested_` / `processed_count_` の二重 atomic + std::mutex(cerr 出力アトミック性)+ lock-free 二重表明を含む構造を確立。UNIT-210 / 402 の試験計画・実績は後続 SDD-準拠ステップで追加する。
...
**累積合計試験ケース(UNIT-200 + UNIT-401 + UNIT-201 + UNIT-202 + UNIT-203 + UNIT-204 + UNIT-205 + UNIT-206 + UNIT-208 + UNIT-301 + UNIT-302 + UNIT-303 + UNIT-304 + UNIT-207 + UNIT-209)= 333 件**
